...
data = session.query(Parroquia).all()

for parroquia in data:
    print(f"""> Parroquia: {parroquia.name}
> Número de Establecimientos: {parroquia.obtenerNumeroEstablecimientos()}\n""")
